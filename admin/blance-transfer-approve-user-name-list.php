                  ...
                  <div class="card-body">
                      ...
                      <table id="example" class="table table-striped table-bordered">
                          ...
                          <tbody>
                             <?php 
                              $sr = '0';
                      $res = mysqli_query($conn, "select * from tbl_blnc_trnsfr_nuser_name  where status = 'Approve' order by id desc ");
                            while($row = mysqli_fetch_assoc($res)){
                              ...
                              <td>
                                 <button type="button" class="btn btn-success btn-rounded"><?= $row['status'];?></button>                                
                              </td>
                          </tr>
                          <?php } ?>
                          </tbody>
